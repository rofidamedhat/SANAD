...
class ProfileActionsSection extends StatelessWidget {
  ...
  const ProfileActionsSection({super.key, required this.cubit});
    ...
    return Column(
      children: [
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: const Color.fromARGB(255, 252, 208, 202),
            padding: const EdgeInsets.symmetric(vertical: 9, horizontal: 65),
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(50),
            ),
          ),
