...
import 'package:sanad/feature/share_question/ui/widgets/contact_now_button.dart';
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              CircleAvatar(
                backgroundImage: NetworkImage(
                  addPostResponseData.profileImageUrl,
                ),
                radius: 30,
              ),
              horizontalSpace(15),
              Column(
                ...
                children: [
                  Text(
                    addPostResponseData.userName,
                    style: TextStyles.font20BlackMedium,
                  ),
                  Text(
                    addPostResponseData.createdAtText,
          ...
          verticalSpace(50),
          Center(
            child: ContactNowButton(addPostResponseData: addPostResponseData),
          ),
          // Center(
          //   child: AppTextButton(
