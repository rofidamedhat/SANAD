...
class _ApiService implements ApiService {
  ...
  @override
  Future<ProfileResponseBody> profile() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ProfileResponseBody>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProfileResponseBody _value;
    try {
      _value = ProfileResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<GetPostResponseBody> getPost() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetPostResponseBody>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'Posts',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetPostResponseBody _value;
    try {
      _value = GetPostResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<EditProfileResponseBody> editProfile(
    ...
    final _options = _setStreamType<EditProfileResponseBody>(
      Options(
            method: 'PUT',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late EditProfileResponseBody _value;
    try {
      _value = EditProfileResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<TranslateVideoResponseBody> uploadVideo(
    ...
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.files.add(MapEntry('Video', videoFile));
    final _options = _setStreamType<TranslateVideoResponseBody>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TranslateVideoResponseBody _value;
    try {
      _value = TranslateVideoResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  @override
  Future<LearnVideosModel> getVideos() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<LearnVideosModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'Videos',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LearnVideosModel _value;
    try {
      _value = LearnVideosModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  @override
  Future<MedicineScheduleResponse> getMedicineSchedule(String day) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'day': day};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MedicineScheduleResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'medications/by-day',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MedicineScheduleResponse _value;
    try {
      _value = MedicineScheduleResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<DeleteMedicineResponse> deleteMedicine(
    DeleteMedicineRequestBody body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
